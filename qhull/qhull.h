...
*/
  ...
  istream* fin;              /* pointer to input file, init by qh_meminit */
  ostream* fout;             /* pointer to output file */
  ostream* ferr;             /* pointer to error file */
...
int     qh_new_qhull (int dim, int numpoints, coordT *points, boolT ismalloc,
		char *qhull_cmd, iostream* outfile, iostream* errfile);
...
void	qh_printneighborhood (iostream* fp, int format, facetT *facetA, facetT *facetB, boolT printall);
...
void    qh_printallstatistics (iostream* fp, char *string);
