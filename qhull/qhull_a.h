...
*/
#ifndef qh_NOtrace
#define trace0(args) {if (qh IStracing) my_fprintf args;}
#define trace1(args) {if (qh IStracing >= 1) my_fprintf args;}
#define trace2(args) {if (qh IStracing >= 2) my_fprintf args;}
#define trace3(args) {if (qh IStracing >= 3) my_fprintf args;}
#define trace4(args) {if (qh IStracing >= 4) my_fprintf args;}
#define trace5(args) {if (qh IStracing >= 5) my_fprintf args;}
#else /* qh_NOtrace */
#define trace0(args) {}
#define trace1(args) {}
#define trace2(args) {}
