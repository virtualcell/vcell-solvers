...
void SMQ_API SimpleLoginCMap_init(ILoginSPICMap*);
 ...
 *                   pass "" if broker is enabled for server authentication
 * @param privateKey the private key for the client cert
 *                   ignored if broker is enabled for server authentication
 *                   pass "" if broker is enabled for server authentication
 * @param ciphers the preferred cipher suite algorithms
 *                if "", default is "RC4-SHA:RC4-MD5"
 *                check http://www.openssl.org/docs/apps/ciphers.html#
 *
 * @return SMQ_SUCCESS (0) if successful, non-zero if error.
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 *
 * @exception JMSException if we fail to set the SSL properties.
 */
int SMQ_API QueueConnectionFactory_setSSLProperties(HOBJ thisObj, HOBJ caDir, HOBJ clientCert, HOBJ privKey, HOBJ ciphers);
...
/**
 * Determines whether the option to enable or disable the minimizing subscriber
 * traffic.
 *
 * @param thisObj the QueueConnectionFactory object to operate against.
 * @param pret If true, minimizing the subscriber traffic.
 *
 * @return SMQ_SUCCESS (0) if successful, non-zero if error.
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 */
int SMQ_API QueueConnectionFactory_getMinimizeSubscriberTraffic(HOBJ thisObj, jboolean *pret);

/**
 * Determines whether compression is enabled or disabled 
 *
 * @param thisObj the QueueConnectionFactory object to operate against.
 * @param pret If true, compression is enabled.
 *
 * @return SMQ_SUCCESS (0) if successful, non-zero if error.
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 */
int SMQ_API QueueConnectionFactory_getEnableCompression(HOBJ thisObj, jboolean *pret);
...
/** 
 * Gets the time, in seconds, that C-Client will wait for a connection before aborting.
 *
 * @return SMQ_SUCCESS (0) if successful, non-zero if error.
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 *
 * @see    setTCPConnectionTimeout()
 */
 ...
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 */
int SMQ_API QueueConnectionFactory_setMinimizeSubscriberTraffic(HOBJ thisObj, jboolean minimizeTraffic);

/**
 * Enable or disable the compression.
 *
 * @param thisObj the QueueConnectionFactory object to operate against.
 * @param enabled   If true, compression is enabled.
 *
 * @return SMQ_SUCCESS (0) if successful, non-zero if error.
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 */
int SMQ_API QueueConnectionFactory_setEnableCompression(HOBJ thisObj, jboolean enabled);
...
/** 
 * Sets the time, in seconds, that C-Client will wait for a connection before aborting.
 * Default value is 30, which allows TCP connection to connect in the allotted time.
 * value zero, tells C-Client to allow the TCP connect call to time out on its own 
 *
 * @param thisObj the QueueConnectionFactory object to operate against.
 * @param timeout The number of seconds to wait for a connection to be established.
 *
 * @return SMQ_SUCCESS (0) if successful, non-zero if error.
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 *
 ...
 * @exception JMSException if we fail to set the SSL properties.
 */
int SMQ_API TopicConnectionFactory_setSSLProperties(HOBJ thisObj, HOBJ caDir, HOBJ clientCert, HOBJ privKey, HOBJ ciphers);
 ...
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 */
int SMQ_API TopicConnectionFactory_getMinimizeSubscriberTraffic(HOBJ thisObj, jboolean *pret);

/**
 * Determines whether the compression is enabled or disabled
 *
 * @param thisObj the TopicConnectionFactory object to operate against.
 * @param pret If true, compression is enabled.
 *
 ...
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 */
int SMQ_API TopicConnectionFactory_getEnableCompression(HOBJ thisObj, jboolean *pret);
...
/**
 * Enables or disables the minimizing subscriber traffic.
 *
 * @param thisObj the TopicConnectionFactory object to operate against.
 * @param minimizeTraffic   If true, minimizing the subscriber traffic.
 *
 ...
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 */
int SMQ_API TopicConnectionFactory_setMinimizeSubscriberTraffic(HOBJ thisObj, jboolean minimizeTraffic);

/**
 * Enables or disables the compression.
 *
 * @param thisObj the TopicConnectionFactory object to operate against.
 * @param enabled If true, enable compression. 
 *
 * @return SMQ_SUCCESS (0) if successful, non-zero if error.
 *         Use SMQ_getLastError() and SMQ_getLastErrorText() to interrogate error details.
 */
int SMQ_API TopicConnectionFactory_setEnableCompression(HOBJ thisObj, jboolean enabled);
