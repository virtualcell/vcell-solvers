...
#ifdef __STDC__
#define XA_USE_PARAMETER_PROTOTYPES
#else /* ifndef __STDC__ */
#ifdef __cplusplus
#define XA_USE_PARAMETER_PROTOTYPES
#else /* ifndef __cplusplus */
#endif /* ifndef __cplusplus */
/* No parameter prototypes */
 ...
 */
#ifdef XA_USE_PARAMETER_PROTOTYPES
extern int ax_reg(int, XID *, long);
extern int ax_unreg(int, long);
#else /* ifndef XA_USE_PARAMETER_PROTOTYPES */
extern int ax_reg();
extern int ax_unreg();
#endif /* ifndef XA_USE_PARAMETER_PROTOTYPES */
/*
...
#define TMBOOTSTRAPMSG	0x00000008L		/* Bootstrap a message received ouside of a transaction */
/*
...
/*
 * The SonicMQ C/C++ Client switch:
 */
SMQ_API extern struct xa_switch_t smq_xa_switch;
