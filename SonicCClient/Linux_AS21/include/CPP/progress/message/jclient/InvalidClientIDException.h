#ifndef _PROGRESS_MESSAGE_JCLIENT_INVALIDCLIENTEXCEPTION_H_
#define _PROGRESS_MESSAGE_JCLIENT_INVALIDCLIENTEXCEPTION_H_
...
class SMQ_API InvalidClientIDException : public JMSException
{
public:
	virtual ~InvalidClientIDException();
...
#endif // _PROGRESS_MESSAGE_JCLIENT_INVALIDCLIENTEXCEPTION_H_
