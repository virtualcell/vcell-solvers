...
#include <progress/message/jclient/IMetricsListener.h>
...
public:
    ...
    */
    ...
    /** Set a metric listener for the connection.
      *
      * At present the listener is intended primarily for internal use by
      * Progress Software and is only invoked for connections that have
      * compression enabled.  The metrics refer to the number of compressed
      * bytes received/delivered over the connection.
      *
      * @param IMetricListener the metrics are delivered to this listener
      *
      */  
    virtual void setMetricsListener(IMetricsListener * listener);

    /** Get metric listener for the connection.
      *
      * At present the listener is intended primarily for internal use by
      * Progress Software and is only invoked for connections that have
      * compression enabled.  The metrics refer to the number of compressed
      * bytes received/delivered over the connection.
      *
      * @return IMetricsListener pointer.
      *
      */
    virtual IMetricsListener*  getMetricsListener();
    ...
    private: void PMJCONNreserved39();
    private: void PMJCONNreserved40();

    private: void PMJCONNreserved41();
    private: void PMJCONNreserved42();
    private: void PMJCONNreserved43();

    private: void PMJCONNreserved44();
