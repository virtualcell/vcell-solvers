      SUBROUTINEPCREDU(N,IJA,A,RHS,X,IPARM,RPARM,NSP,ISP,RSP,
     ...
     *IFRMAT
      ...
      CALLPCIABS(N,IJA)
      ENDIF
      CALLPCREDP(N,IJA,A,RHS,X,ISP,RSP,METHOD,PRECON,PCSTOP,PCMV)
      ELSE
      CALLPCREDB(N,IJA,A,RHS,X,ISP,RSP,METHOD,PRECON,PCSTOP,PCMV)
      ENDIF
      IF(IJASGN.EQ.0)THEN
