...
public:
    ...
    void setupUi(CopasiWidget *CQFunctionsWidget)
    {
        ...
        mpTblFunctions = new QTableView(CQFunctionsWidget);
        mpTblFunctions->setObjectName(QString::fromUtf8("mpTblFunctions"));
        mpTblFunctions->setEditTriggers(QAbstractItemView::DoubleClicked|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
