...
public:
    ...
    void setupUi(CopasiWidget *CQSpeciesWidget)
    {
        ...
        mpTblSpecies = new QTableView(CQSpeciesWidget);
        mpTblSpecies->setObjectName(QString::fromUtf8("mpTblSpecies"));
        mpTblSpecies->setEditTriggers(QAbstractItemView::DoubleClicked|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
