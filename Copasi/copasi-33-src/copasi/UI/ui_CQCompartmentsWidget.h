...
public:
    ...
    void setupUi(CopasiWidget *CQCompartmentsWidget)
    {
        ...
        mpTblCompartments = new QTableView(CQCompartmentsWidget);
        mpTblCompartments->setObjectName(QString::fromUtf8("mpTblCompartments"));
        mpTblCompartments->setEditTriggers(QAbstractItemView::DoubleClicked|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
