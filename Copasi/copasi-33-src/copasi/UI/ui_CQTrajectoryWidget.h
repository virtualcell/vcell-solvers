...
public:
    ...
    void setupUi(TaskWidget *CQTrajectoryWidget)
    {
        ...
        CQTrajectoryWidget->resize(475, 235);
        ...
        mpGridLayout->addWidget(mpCheckSave, 3, 1, 1, 3);
        ...
        mpGridLayout->addWidget(mpLblOutputInterval, 6, 0, 1, 1);
        ...
        mpGridLayout->addWidget(mpEditOutputInterval, 6, 1, 1, 1);
