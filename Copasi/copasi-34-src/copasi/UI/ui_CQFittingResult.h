...
public:
    ...
    void setupUi(CopasiWidget *CQFittingResult)
    {
        ...
        CQFittingResult->resize(569, 252);
        ...
        mpBtnUpdateModel = new QPushButton(CQFittingResult);
        mpBtnUpdateModel->setObjectName(QString::fromUtf8("mpBtnUpdateModel"));

        horizontalLayout->addWidget(mpBtnUpdateModel);
        ...
        QObject::connect(mpBtnUpdateModel, SIGNAL(clicked()), CQFittingResult, SLOT(slotUpdateModel()));
    ...
    void retranslateUi(CopasiWidget *CQFittingResult)
    {
        ...
        mpBtnUpdateModel->setText(QApplication::translate("CQFittingResult", "Update Model", 0, QApplication::UnicodeUTF8));
