...
public:
    ...
    void setupUi(CopasiWidget *CQSpeciesDetail)
    {
        ...
        CQSpeciesDetail->resize(460, 486);
        ...
        mpReactionTable->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
        ...
        QObject::connect(mpEditInitialValue, SIGNAL(lostFocus()), CQSpeciesDetail, SLOT(slotInitialValueLostFocus()));
