...
public:
    ...
    void setupUi(CopasiWidget *CQEventsWidget)
    {
        ...
        mpTblEvents = new CQTableView(CQEventsWidget);
        mpTblEvents->setObjectName(QString::fromUtf8("mpTblEvents"));
        mpTblEvents->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
        ...
        mpTblEvents->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
