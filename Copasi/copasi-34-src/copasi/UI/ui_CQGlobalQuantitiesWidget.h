...
public:
    ...
    CQTableView *mpTblGlobalQuantities;
    ...
    void setupUi(CopasiWidget *CQGlobalQuantitiesWidget)
    {
        ...
        mpTblGlobalQuantities = new CQTableView(CQGlobalQuantitiesWidget);
        mpTblGlobalQuantities->setObjectName(QString::fromUtf8("mpTblGlobalQuantities"));
        mpTblGlobalQuantities->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
        ...
        mpTblGlobalQuantities->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
