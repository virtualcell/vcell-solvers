...
public:
    ...
    void setupUi(CopasiWidget *CQPlotsWidget)
    {
        ...
        mpTblPlots = new CQTableView(CQPlotsWidget);
        mpTblPlots->setObjectName(QString::fromUtf8("mpTblPlots"));
        mpTblPlots->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
        ...
        mpTblPlots->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
