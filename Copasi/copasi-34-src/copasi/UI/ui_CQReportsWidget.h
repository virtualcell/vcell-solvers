...
public:
    ...
    void setupUi(CopasiWidget *CQReportsWidget)
    {
        ...
        mpTblReports = new CQTableView(CQReportsWidget);
        mpTblReports->setObjectName(QString::fromUtf8("mpTblReports"));
        mpTblReports->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
        ...
        mpTblReports->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
