...
public:
    ...
    CQTableView *mpTblDescription;
    CQTableView *mpTblModified;
    CQTableView *mpTblReferences;
    CQTableView *mpTblAuthors;
    ...
    void setupUi(CopasiWidget *CQMiriamWidget)
    {
        ...
        mpTblDescription = new CQTableView(CQMiriamWidget);
        mpTblDescription->setObjectName(QString::fromUtf8("mpTblDescription"));
        mpTblDescription->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
        ...
        mpTblDescription->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
        mpTblDescription->setSortingEnabled(true);

        gridLayout->addWidget(mpTblDescription, 3, 1, 1, 3);

        mpTblModified = new CQTableView(CQMiriamWidget);
        mpTblModified->setObjectName(QString::fromUtf8("mpTblModified"));
        mpTblModified->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
        ...
        mpTblModified->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
        mpTblModified->setSortingEnabled(true);

        gridLayout->addWidget(mpTblModified, 4, 1, 1, 3);

        mpTblReferences = new CQTableView(CQMiriamWidget);
        mpTblReferences->setObjectName(QString::fromUtf8("mpTblReferences"));
        mpTblReferences->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
        ...
        mpTblReferences->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
        mpTblReferences->setSortingEnabled(true);

        gridLayout->addWidget(mpTblReferences, 2, 1, 1, 3);

        mpTblAuthors = new CQTableView(CQMiriamWidget);
        mpTblAuthors->setObjectName(QString::fromUtf8("mpTblAuthors"));
        mpTblAuthors->setEditTriggers(QAbstractItemView::CurrentChanged|QAbstractItemView::EditKeyPressed|QAbstractItemView::SelectedClicked);
        ...
        mpTblAuthors->setHorizontalScrollMode(QAbstractItemView::ScrollPerPixel);
