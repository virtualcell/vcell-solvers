 ...
 *
 * $Id: SBase.cpp 13378 2011-03-29 10:49:33Z sarahkeating $
 * $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/SBase.cpp $
 *
 * <!--------------------------------------------------------------------------
  ...
  switch (getLevel())
  {
    case 1:
     ...
     switch (version)
      ...
      break;
    case 2:
      // some components didnt exist in level 2
