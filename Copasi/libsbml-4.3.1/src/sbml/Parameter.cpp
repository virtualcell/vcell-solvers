 ...
 *
 * $Id: Parameter.cpp 13254 2011-03-20 12:09:31Z sarahkeating $
 * $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/Parameter.cpp $
 *
 * <!--------------------------------------------------------------------------
...
Parameter::getDerivedUnitDefinition()
{
  ...
  if (m != NULL)
  {
    ...
    */
    ...
    if (getParentSBMLObject()->getParentSBMLObject()
