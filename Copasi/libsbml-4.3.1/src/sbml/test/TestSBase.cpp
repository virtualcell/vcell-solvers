 ...
 *
 * $Id: TestSBase.cpp 13286 2011-03-23 13:31:21Z sarahkeating $
 * $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/test/TestSBase.cpp $
 *
 * <!--------------------------------------------------------------------------
...
START_TEST(test_SBase_accessWithNULL)
{
  ...
  fail_unless(SBase_getColumn(NULL) == (unsigned int)(SBML_INT_MAX));
  fail_unless(SBase_getCVTerm(NULL, 0 ) == NULL);
  fail_unless(SBase_getCVTerms(NULL) == NULL);
  fail_unless(SBase_getElementName(NULL) == NULL);
  fail_unless(SBase_getLevel(NULL) == (unsigned int)(SBML_INT_MAX));
  fail_unless(SBase_getLine(NULL) == (unsigned int)(SBML_INT_MAX));
  ...
  fail_unless(SBase_getNumCVTerms(NULL) == (unsigned int)(SBML_INT_MAX));
  ...
  fail_unless(SBase_getVersion(NULL) == (unsigned int)(SBML_INT_MAX));
