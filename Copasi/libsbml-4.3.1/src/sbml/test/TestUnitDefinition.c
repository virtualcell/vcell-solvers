 ...
 *
 * $Id: TestUnitDefinition.c 13054 2011-02-26 00:32:46Z fbergmann $
 * $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/test/TestUnitDefinition.c $
 *
 * <!--------------------------------------------------------------------------
