 ...
 *
 * $Id: TestSBMLConstructorException.cpp 13286 2011-03-23 13:31:21Z sarahkeating $
 * $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/test/TestSBMLConstructorException.cpp $
 *
 * <!--------------------------------------------------------------------------
...
START_TEST ( test_SBMLConstructorException_ModifierSpeciesReference )
{
  ...
  ModifierSpeciesReference *s = NULL;
  msg = "";
  try
  {
