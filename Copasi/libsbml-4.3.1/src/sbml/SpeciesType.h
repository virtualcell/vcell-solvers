 ...
 *
 * $Id: SpeciesType.h 13118 2011-03-03 04:14:03Z mhucka $
 * $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/sbml/SpeciesType.h $
 *
 * <!--------------------------------------------------------------------------
 ...
 * @if java @see ListOfCompartmentTypes@endif
 * 
 * <!---------------------------------------------------------------------- -->
 *
