 ...
 * @author  Ralph Gauges
 *
 * $Id: LayoutAnnotation.h 13269 2011-03-21 22:28:11Z mhucka $
 * $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/annotation/LayoutAnnotation.h $
 *
