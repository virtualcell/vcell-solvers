/**
 * @file    local.cpp
 * @brief   Ruby-specific SWIG support code for wrapping libSBML API
 * @author  Ben Bornstein and Ben Kovitz
 * @author  Alex Gutteridge
 * @author  Akiya Jouraku
 *
 * $Id: local.cpp 12780 2011-02-08 04:12:54Z mhucka $
 * $HeadURL: http://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/bindings/ruby/local.cpp $
 *
 * <!--------------------------------------------------------------------------
