...
int zi_opts(__G__ int *pargc, char ***pargv)
    //int *pargc;
    //char ***pargv;
    __GDEF
{
...
static int zi_long(__G__ ulg *pEndprev)   /* return PK-type error code */
    __GDEF
...
static void zi_showMacTypeCreator(__G__ uch *ebfield)
    __GDEF
    //uch *ebfield;
{
...
static char *zi_time(__G__ ZCONST ulg *datetimez, ZCONST time_t *modtimez, char *d_t_str)
    __GDEF
