...
char *do_wild(__G__ ZCONST char* wildspec)
    __GDEF
...
int checkdir(__G__ char* pathcomp, int flag)
    __GDEF
//    char *pathcomp;
 //   int flag;
/*
...
int mkdir(ZCONST char* path, int mode)
//    ZCONST char *path;
 //   int mode;   /* ignored */
/*
...
int set_direc_attribs(__G__ dirtime* d)
    __GDEF
//    dirtime *d;
{
    int errval = PK_OK;
