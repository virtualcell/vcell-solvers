...
int UzpMain(int argc, char*argv[])   /* return PK-type error code (except under VMS) */
    //int argc;
    //char *argv[];
{
    int r;
...
int usage(__G__ int error)   /* return PK-type error code */
    __GDEF
    //int error;
{
    int flag = (error? 1 : 0);
...
int unzip32(char* zipfile, char* file, char* exdir)   /* return PK-type error code (except under VMS) */
	//char* zipfile;
	//char* file;
	//char* exdir;
{
