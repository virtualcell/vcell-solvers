...
${OBJECTDIR}/src/ChomboEBBC.o: src/ChomboEBBC.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.cc) -g -DCH_CYGWIN -DCH_FORT_UNDERSCORE -DCH_LANG_CC -DCH_SPACEDIM=3 -DCH_USE_64 -DCH_USE_COMPLEX -DCH_USE_DOUBLE -DCH_USE_HDF5 -DCH_USE_MEMORY_TRACKING -DCH_USE_SETVAL -DH5_USE_16_API -I../Chombo/lib/include -I../numerics/ExpressionParser -Iinclude -I../numerics/hdf5-1.8.8/c++/src -I../numerics/hdf5-1.8.8/src -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/ChomboEBBC.o src/ChomboEBBC.cpp
