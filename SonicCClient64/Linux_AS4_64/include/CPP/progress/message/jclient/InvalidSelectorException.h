#ifndef _PROGRESS_MESSAGE_JCLIENT_INVALIDSELECTOREXCEPTION_H_
#define _PROGRESS_MESSAGE_JCLIENT_INVALIDSELECTOREXCEPTION_H_
...
class SMQ_API InvalidSelectorException : public JMSException
{
public:
	virtual ~InvalidSelectorException();
...
#endif // _PROGRESS_MESSAGE_JCLIENT_INVALIDSELECTOREXCEPTION_H_
